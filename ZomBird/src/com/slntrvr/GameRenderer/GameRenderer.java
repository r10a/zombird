package com.slntrvr.GameRenderer;
...
import com.slntrvr.GameObjects.Grass;
import com.slntrvr.GameObjects.Pipe;
...
public class GameRenderer {
    ...
    public void render(float runTime) {
        ...
        if (myWorld.isReady()) {
            ...
            //CopyRights:P
            AssetLoader.shadow.draw(batcher, "Game By", (136 / 2) - (35), 191);           
            AssetLoader.font
                    .draw(batcher, "Game By", (136 / 2) - (35 - 1), 190);
            
            AssetLoader.shadow.draw(batcher, "Slntrvr", (136 / 2) - (30), 220);           
            AssetLoader.font
                    .draw(batcher, "Slntrvr", (136 / 2) - (30 - 1), 219);
